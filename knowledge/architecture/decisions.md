...
## Recommended bounded M6

Add bounded dynamic string-table access and offset/string observations from M5's checked descriptor,
using generated bytes. Define termination, byte encoding and per-string/work budgets before deriving
names. Do not resolve dependencies, parse symbols/relocations, interpret Sony tags or apply runtime state.
This is a recommendation only; M6 has not started. Existing unrelated decision gates remain open.
