...
M17 extracts discovery/traversal to observation/raw.rs; observation/inspect.rs retains the separate descriptor step. Dynamic entry vector growth is now fallible with a structured Allocation diagnostic. See [explicit raw observation](explicit_dynamic_observation.md).
